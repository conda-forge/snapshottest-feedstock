...
Once the `conda-forge` channel has been enabled, `snapshottest` can be installed with:

```
conda install snapshottest
```

It is possible to list all of the versions of `snapshottest` available on your platform with:
